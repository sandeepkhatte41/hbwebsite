...
<button id="pay-button" style="margin: 20px; padding: 10px 20px; background-color: #3399cc; color: white; border: none; border-radius: 5px;">Pay ₹500</button>
...
document.getElementById('pay-button').onclick = function (e) {
    var options = {
        ...
        "amount": "50000", // Amount is in paise (50000 = ₹500)
        "currency": "INR",
        "name": "HBWebsite Booking",
